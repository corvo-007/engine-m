...
namespace EngineM::kernels::avx2 {
    ...
    void matrix_mul(const float (&a)[3][3], const float (&b)[3][3], float (&out)[3][3]) {
        ...
        out[0][0] = row0col0xrow0col1[0];
        out[0][1] = row0col0xrow0col1[4];
        out[0][2] = row0col2xrow1col2[0];
        out[1][0] = row1col0xrow1col1[0];
        out[1][1] = row1col0xrow1col1[4];
        out[1][2] = row0col2xrow1col2[4];
        out[2][0] = row2col0xrow2col1[0];
        out[2][1] = row2col0xrow2col1[4];
        out[2][2] = row2col2xrow2col2[0];
    }
}