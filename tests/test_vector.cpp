...
TEST(Vector3dTest, ParamConstruct1) {
...
TEST(Vector3dTest, ParamConstruct2) {
    const EngineM::vec2f v1(1.3, 6.7);
    const EngineM::vec3f v2 = {v1, 3.2};

    EXPECT_FLOAT_EQ(v2.x, v1.x);
    EXPECT_FLOAT_EQ(v2.y, v1.y);
    EXPECT_FLOAT_EQ(v2.z, 3.2);
}
...
TEST(Vector3dTest, XY_YZ_XZ) {
    const EngineM::vec3f v1(2.5, 83.2, 0.3);

    EngineM::vec2f v2 = v1.xy();

    EXPECT_FLOAT_EQ(v2.x, 2.5);
    EXPECT_FLOAT_EQ(v2.y, 83.2);

    v2 = v1.yz();

    EXPECT_FLOAT_EQ(v2.x, 83.2);
    EXPECT_FLOAT_EQ(v2.y, 0.3);
...
TEST(Vector4dTest, ParamConstruct) {
    const EngineM::vec3f v1 = {1.3, 6.7, 2.5};

    const EngineM::vec4f v2 = {v1, 8.2};

    EXPECT_FLOAT_EQ(v2.x, v1.x);
    EXPECT_FLOAT_EQ(v2.y, v1.y);
    EXPECT_FLOAT_EQ(v2.z, v1.z);
    EXPECT_FLOAT_EQ(v2.w, 8.2);
}

TEST(Vector4dTest, XY_YZ_XZ_XYZ) {
    const EngineM::vec4f v1(2.5, 83.2, 0.3, 35.03);
    ...
    EngineM::vec3f v3 = v1.xyz();

    EXPECT_FLOAT_EQ(v3.x, 2.5);
    EXPECT_FLOAT_EQ(v3.y, 83.2);
    EXPECT_FLOAT_EQ(v3.z, 0.3);
}
